...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
 ...
 // Bind parameters
 $stmt->bind_param("isssssssssssss", $user_id, $filiere, $option, $major, $cesure, $cesure_type, $cesure_domaine, $mobilite, $mobilite_option, $stage_observation, $stage_2eme_annee, $competence, $mentorat, $interet);
                ...
                <div class="user-details">
                    <div class="input-box">
                        ...
                        <select name="major" required>
                            ...
                            <option value="Modélisation et Matériaux">Aucun</option>
                        </select>
                    </div>
                    ...
                    <div class="input-box">
                        ...
                        <select name="filiere" required>
                            ...
                            <option value="Modélisation et Matériaux">Autre</option>
                        </select>
                    </div>
