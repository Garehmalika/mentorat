...
<body>
    <div class="container">
        <div class="title">Pourriez-vous prendre une minute pour remplir ce formulaire ?</div>
        <div class="content">
            <form method="post" action="" enctype="multipart/form-data">
                <div class="user-details">
                    <div class="input-box">
                        <span class="details">Quelle majeure envisagez-vous d'intégrer en 2ème année ?</span>
